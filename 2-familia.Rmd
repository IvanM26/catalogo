...
<!-- Las imagenes se deben guardar, en este caso, dentro de img/head -->

<!-- \fancyhead[C]{\includegraphics{img/head/{{i}}.jpg}} -->
...
<!-- \lfoot{\includegraphics{img/foot/{{i}}.jpg}} -->
...
\begin{tcolorbox}
  \textsc{\huge{\textbf{\textcolor{yellow}{ {{i}} }}}}
\end{tcolorbox}
